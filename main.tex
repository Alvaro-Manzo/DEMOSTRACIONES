...
Donde se encuentra el código de este archivo existen demas codigos en LaTeX que podrian ser de interés para cualquier persona curiosa, le recomiendo estar al tanto del repositorio.
...
\subsection{Demostración del teorema del binomio para exponente $2$}
...
\section{Propiedades Geometricas}
...
\textbf{Aritmética:} Rama de las matemáticas que estudia los números y las operaciones básicas como suma, resta, multiplicación y división.

\vspace{0.5em}

\textbf{Álgebra:} Rama de las matemáticas que utiliza símbolos y letras para representar números y expresar relaciones.

\vspace{0.5em}

\textbf{Número par:} Número entero divisible entre 2.

\vspace{0.5em}

\textbf{Número impar:} Número entero que no es divisible entre 2.
...
\textbf{Número irracional:} Número que no puede expresarse como fracción de dos enteros.

\vspace{0.5em}

\textbf{Demostración:} Argumento lógico que prueba la veracidad de una proposición matemática.

\vspace{0.5em}

\textbf{Proposición:} Enunciado matemático que puede ser verdadero o falso.

\vspace{0.5em}

\textbf{Teorema:} Proposición que ha sido demostrada mediante un razonamiento lógico.

\vspace{0.5em}

\textbf{Lema:} Resultado auxiliar utilizado para demostrar otros teoremas.

\vspace{0.5em}

\textbf{Contradicción:} Método de demostración donde se asume lo contrario de lo que se quiere probar y se llega a una imposibilidad.

\vspace{0.5em}

\textbf{Inducción matemática:} Método de demostración que prueba un caso base y luego demuestra que si se cumple para $n$, se cumple para $n+1$.

\vspace{0.5em}

\textbf{Propiedad distributiva:} Propiedad que establece que $a(b+c) = ab + ac$.

\vspace{0.5em}

\textbf{Factorización:} Proceso de expresar una expresión como producto de factores.

\vspace{0.5em}

\textbf{Cuadrado perfecto:} Expresión que puede escribirse como el cuadrado de otra.

\vspace{0.5em}

\textbf{Triángulo rectángulo:} Triángulo que tiene un ángulo de $90^\circ$.

\vspace{0.5em}

\textbf{Hipotenusa:} Lado más largo de un triángulo rectángulo.

\vspace{0.5em}

\textbf{Catetos:} Los dos lados que forman el ángulo recto en un triángulo.

\vspace{0.5em}

\textbf{Congruente:} Figuras que tienen la misma forma y tamaño.

\vspace{0.5em}

\textbf{Área:} Medida de la superficie de una figura.

\vspace{0.5em}

\textbf{$\mathbb{Z}$:} Conjunto de los números enteros.

\vspace{0.5em}

\textbf{$\mathbb{N}$:} Conjunto de los números naturales.
